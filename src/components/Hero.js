...
const Hero = () => {
  ...
  return <section className='bg-hero bg-cover bg-center min-h-[40vh] lg:h-[948px] bg-no-repeat relative mt-[120px] lg:mt-[150px]' id='home'>
    <motion.div
      variants={container}
      initial='hidden'
      whileInView={'show'}
      ...
      <div className='text-white text-center lg:text-left lg:max-w-[640px]'>
        ...
        <motion.div variants={fadeIn('down')}>
          <a href='https://www.spacex.com/launches/sl4-36/'>
